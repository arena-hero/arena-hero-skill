...
> Bundled from `arena-hero-doc` commit `e98859c001c9faf8161f9f32b0b58d2937f49bc3`: `docs/api/websocket.md`.
...
they are visible. For every field, see the [State model](api-state-model.md); for
`events`, see [Resolution results](api-resolution-results.md).
