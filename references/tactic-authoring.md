...
- [Complete Arena Hero v0.5 rules](game-rules.md)
...
knowledge. If the live contract is newer than the bundled v0.5 rules, stop and
...
```bash
python -m pip install 'arena-hero>=0.2.3,<0.3'
```
